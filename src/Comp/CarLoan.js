...
const CarLoan = () => {
  const [data,setData]=useState(400000)
// const [ value, setValue ] = useState(0); 
const [int,setInt]=useState(8.5);
...
// console.log(yrs)
  ...
  return (
    <div className='container border p-4 w-50'>
      <h1>EMI Calculator For Car Loan</h1>

    <p className=''>Car Loan Amount</p> <input type='number' value={data} disabled></input><button><FontAwesomeIcon icon={faIndianRupeeSign}></FontAwesomeIcon></button>
    <br></br>
    <br></br>
